...
def generate_demo_cohort(seed: int = 42, n_per_cohort: int = 120) -> DemoCohortBundle:
    ...
    for cohort_index, cohort in enumerate(COHORTS):
        ...
        for person_index in range(n_per_cohort):
            ...
            base = _generate_baseline_traits(rng, cohort, setting)

            annual_hazard, event, event_time_years, event_time_days = _generate_event(rng, base)
                ...
                visit_rows.append(
                    {
                        ...
                        "age_at_visit": base.age + max(year_offset, 0.0),
